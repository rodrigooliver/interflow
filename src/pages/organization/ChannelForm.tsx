...
import { EmailChannelForm } from '../../components/channels/EmailChannelForm';
...
export default function ChannelForm() {
  ...
  const [formData, setFormData] = useState({
    name: '',
    type: 'email' as ChatChannel['type'],
  ...
  async function loadChannel() {
    try {
      ...
      if (data) {
        ...
        const credentials = typeof data.credentials === 'object' ? data.credentials : {};
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div>
              ...
              <select
                ...
                className="w-full rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 h-10 px-3"
                value={formData.type}
                onChange={(e) => setFormData({ ...formData, type: e.target.value as ChatChannel['type'] })}
              >
            ...
            {formData.type === 'email' && (
              <EmailChannelForm
                initialConfig={formData.credentials}
