...
const SchedulesListPage: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col p-5 bg-gray-50 dark:bg-gray-900">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
            <div>
              <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-800 dark:text-white flex items-center">
                <CalendarDays className="h-6 w-6 sm:h-8 sm:w-8 mr-2 text-blue-600 dark:text-blue-400" />
            ...
            <div className="flex gap-2 w-full sm:w-auto">
              <button
                ...
                className="flex-1 sm:flex-none inline-flex items-center justify-center px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 transition-colors"
              >
              ...
              <button
                onClick={handleCreateSchedule}
                className="flex-1 sm:flex-none inline-flex items-center justify-center px-3 py-2 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 transition-colors"
              >
                ...
                {schedules.map((schedule) => (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      ...
                      <div>
                        <span className="text-gray-500 dark:text-gray-400">{t('schedules:providers')}:</span>
                        <span className="ml-1 text-gray-900 dark:text-white">{schedule.providers?.length || 0}</span>
                      </div>
                      <div>
                        <span className="text-gray-500 dark:text-gray-400">{t('schedules:services')}:</span>
                        <span className="ml-1 text-gray-900 dark:text-white">{schedule.services?.length || 0}</span>
                      </div>
                      <div>
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black bg-opacity-60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fadeIn pb-16 md:pb-0">
          <div 
